...
class RoomServiceClient extends $grpc.Client {
  static final _$createRoom = $grpc.ClientMethod<$0.CreateRoomRequest, $0.CreateRoomReply>(
      '/room.RoomService/CreateRoom',
      ($0.CreateRoomRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.CreateRoomReply.fromBuffer(value));
  static final _$updateRoom = $grpc.ClientMethod<$0.UpdateRoomRequest, $0.UpdateRoomReply>(
      '/room.RoomService/UpdateRoom',
      ($0.UpdateRoomRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdateRoomReply.fromBuffer(value));
  static final _$endRoom = $grpc.ClientMethod<$0.EndRoomRequest, $0.EndRoomReply>(
  ...
  static final _$getRooms = $grpc.ClientMethod<$0.GetRoomsRequest, $0.GetRoomsReply>(
  ...
  static final _$addPeer = $grpc.ClientMethod<$0.AddPeerRequest, $0.AddPeerReply>(
  ...
  static final _$updatePeer = $grpc.ClientMethod<$0.UpdatePeerRequest, $0.UpdatePeerReply>(
      '/room.RoomService/UpdatePeer',
      ($0.UpdatePeerRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdatePeerReply.fromBuffer(value));
  static final _$removePeer = $grpc.ClientMethod<$0.RemovePeerRequest, $0.RemovePeerReply>(
      '/room.RoomService/RemovePeer',
      ($0.RemovePeerRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.RemovePeerReply.fromBuffer(value));
  static final _$getPeers = $grpc.ClientMethod<$0.GetPeersRequest, $0.GetPeersReply>(
  ...
  $grpc.ResponseFuture<$0.CreateRoomReply> createRoom($0.CreateRoomRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createRoom, request, options: options);
  }

  $grpc.ResponseFuture<$0.UpdateRoomReply> updateRoom($0.UpdateRoomRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateRoom, request, options: options);
  }

  $grpc.ResponseFuture<$0.EndRoomReply> endRoom($0.EndRoomRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$endRoom, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetRoomsReply> getRooms($0.GetRoomsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getRooms, request, options: options);
  }

  $grpc.ResponseFuture<$0.AddPeerReply> addPeer($0.AddPeerRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addPeer, request, options: options);
  }

  $grpc.ResponseFuture<$0.UpdatePeerReply> updatePeer($0.UpdatePeerRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updatePeer, request, options: options);
  }

  $grpc.ResponseFuture<$0.RemovePeerReply> removePeer($0.RemovePeerRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$removePeer, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetPeersReply> getPeers($0.GetPeersRequest request, {$grpc.CallOptions? options}) {
...
abstract class RoomServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.CreateRoomReply> createRoom_Pre($grpc.ServiceCall call, $async.Future<$0.CreateRoomRequest> request) async {
    return createRoom(call, await request);
  }

  $async.Future<$0.UpdateRoomReply> updateRoom_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateRoomRequest> request) async {
    return updateRoom(call, await request);
  }

  $async.Future<$0.EndRoomReply> endRoom_Pre($grpc.ServiceCall call, $async.Future<$0.EndRoomRequest> request) async {
    return endRoom(call, await request);
  }

  $async.Future<$0.GetRoomsReply> getRooms_Pre($grpc.ServiceCall call, $async.Future<$0.GetRoomsRequest> request) async {
    return getRooms(call, await request);
  }

  $async.Future<$0.AddPeerReply> addPeer_Pre($grpc.ServiceCall call, $async.Future<$0.AddPeerRequest> request) async {
    return addPeer(call, await request);
  }

  $async.Future<$0.UpdatePeerReply> updatePeer_Pre($grpc.ServiceCall call, $async.Future<$0.UpdatePeerRequest> request) async {
    return updatePeer(call, await request);
  }

  $async.Future<$0.RemovePeerReply> removePeer_Pre($grpc.ServiceCall call, $async.Future<$0.RemovePeerRequest> request) async {
    return removePeer(call, await request);
  }

  $async.Future<$0.GetPeersReply> getPeers_Pre($grpc.ServiceCall call, $async.Future<$0.GetPeersRequest> request) async {
    return getPeers(call, await request);
  }

  $async.Future<$0.CreateRoomReply> createRoom($grpc.ServiceCall call, $0.CreateRoomRequest request);
  $async.Future<$0.UpdateRoomReply> updateRoom($grpc.ServiceCall call, $0.UpdateRoomRequest request);
  $async.Future<$0.EndRoomReply> endRoom($grpc.ServiceCall call, $0.EndRoomRequest request);
  $async.Future<$0.GetRoomsReply> getRooms($grpc.ServiceCall call, $0.GetRoomsRequest request);
  $async.Future<$0.AddPeerReply> addPeer($grpc.ServiceCall call, $0.AddPeerRequest request);
  $async.Future<$0.UpdatePeerReply> updatePeer($grpc.ServiceCall call, $0.UpdatePeerRequest request);
  $async.Future<$0.RemovePeerReply> removePeer($grpc.ServiceCall call, $0.RemovePeerRequest request);
  $async.Future<$0.GetPeersReply> getPeers($grpc.ServiceCall call, $0.GetPeersRequest request);
}
