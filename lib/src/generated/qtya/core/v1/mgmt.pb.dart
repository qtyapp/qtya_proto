...
import 'platformuser.pb.dart' as $3;
...
class AddUserRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddUserRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'qtya.core.v1'), createEmptyInstance: create)
    ..aOM<$3.PlatformUser>(1, _omitFieldNames ? '' : 'user', subBuilder: $3.PlatformUser.create)
  ...
  @$pb.TagNumber(1)
  $3.PlatformUser get user => $_getN(0);
  @$pb.TagNumber(1)
  set user($3.PlatformUser v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUser() => $_has(0);
  @$pb.TagNumber(1)
  void clearUser() => clearField(1);
  @$pb.TagNumber(1)
  $3.PlatformUser ensureUser() => $_ensure(0);
